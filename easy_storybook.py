...
# ==================== DeepSeek 配置 ====================
# 在此填入你的 DeepSeek API Key，或设置环境变量 DEEPSEEK_API_KEY
DEEPSEEK_API_KEY = ""
...
def get_deepseek_api_key():
    """获取 DeepSeek API Key，优先度：配置文件 > 环境变量 > 运行时输入"""
    if DEEPSEEK_API_KEY:
    ...
    print("=" * 50)
    print("请先在 easy_storybook.py 顶部填入 DEEPSEEK_API_KEY，")
